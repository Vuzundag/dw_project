drop procedure silver.load_data;
...
begin
    ...
    begin
        ...
        select '================================================================' as message;
        select CONCAT('Error occurred during Silver Layer load: ', @errno, ' ', @text) as error_message;
        select 'Procedure execution halted due to errors' as message;
        select '================================================================' as message;
	...
	where flag_last = 1;
	set @end_time = now();
    select 'Load Duration: ' + timestampdiff(second, @start_time, @end_time) + ' seconds' as message;
